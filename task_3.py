...
for mb in range(connection_speed, file_size, connection_speed):
  print("Прошло " + str(second) + " секунд. Скачано " + str(mb) + " из " +
        str(file_size) + " МБ (" + str(math.ceil(100 * mb / file_size)) + "%)")
  second += 1
else:
  print("Прошло " + str(second) + " секунд. Скачано " + str(file_size) +
        " из " + str(file_size) + " МБ (" +
        str(math.ceil(100 * file_size / file_size)) + "%)")
